...
<body>
    ...
    <c:if test="${check == 'admin'}">
        <form action="ResultSearch" method="post">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/Admissoions/AdminAdmissionsControll">ADMISSIONS</a>
                        </li>
                        <li class="nav-item">
            ...
            <button style="margin-left: 10%; margin-top: 10px; width: 80px;" type="submit"><a href="/Admissions/AddNewMajor.jsp">Add</a></button>
                ...
                <table style="border-collapse: collapse; width: 80%; margin: 20px auto;" border="1">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">Subject</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">MajorName</th>
                    ...
                    <c:forEach items="${list}" var="l">
                        <tr>
                            ...
                            <td style="text-align: center; padding: 8px;">${l.subject}</td>
                            <td style="text-align: center; padding: 8px;">${l.majorName}</td>
                            <td style="text-align: center; padding: 8px;"><a style="text-decoration: none;" href="/Admissions/updateMajor?id=${l.id}">Edit</a></td>
                            <td style="text-align: center; padding: 8px;"><a style="text-decoration: none;" href="/Admissions/deleteMajor?id=${l.id}">Delete</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
