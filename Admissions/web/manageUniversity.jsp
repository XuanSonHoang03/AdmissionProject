...
<body>
    ...
    <c:if test="${check == 'admin'}">
        <form action="ResultSearch" method="post">
            ...
            <button style="margin-left: 10%; margin-top: 10px; width: 80px;" type="submit"><a href="/Admissions/AddNewUniversity.jsp">Add</a></button>
                ...
                <table style="border-collapse: collapse; width: 80%; margin: 20px auto;" border="1">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">Code</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">nameEnglish</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">name</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">area</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">location</th>
                            <th style="background-color: #f2f2f2; font-weight: bold; text-align: center; padding: 8px;">type</th>
                    ...
                    <c:forEach items="${list}" var="l">
                        <tr>
                            ...
                            <td style="text-align: center; padding: 8px;">${l.code}</td>
                            <td style="text-align: center; padding: 8px;">${l.nameEnglish}</td>
                            <td style="text-align: center; padding: 8px;">${l.name}</td>
                            <td style="text-align: center; padding: 8px;">${l.area}</td>
                            <td style="text-align: center; padding: 8px;">${l.location}</td>
                            <td style="text-align: center; padding: 8px;">${l.type}</td>
                            <td style="text-align: center; padding: 8px;"><a style="text-decoration: none;" href="/Admissions/updateUniversity?id=${l.id}">Edit</a></td>
                            <td style="text-align: center; padding: 8px;"><a style="text-decoration: none;" href="/Admissions/DeleteUniversity?id=${l.id}">Delete</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
